  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center px-4 md:px-6">
        ...
        {/* Availability info (mobile + desktop) */}
        <div className="mt-4 md:mt-6 lg:mt-8 flex flex-col items-center gap-2 text-center md:flex-row md:gap-4 md:text-left md:justify-center">
          <div className="flex items-center gap-1.5 text-sm text-gray-700">
            ...
            <span className="text-xs font-medium md:text-sm">Apple Wallet</span>
            ...
            <span className="text-xs font-medium md:text-sm">Google Wallet</span>
          </div>
          <div className="flex items-center gap-1 text-xs font-semibold text-gray-900 md:text-sm">
