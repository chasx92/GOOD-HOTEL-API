    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center px-4 md:px-6">
        ...
        >
          ...
          {/* Mobile status + wallets */}
          <div className="flex items-center justify-center gap-3 mb-4 md:hidden text-[13px] text-gray-900">
            ...
            <div className="flex items-center gap-1.5 text-gray-600 whitespace-nowrap">
              ...
              <span className="text-[12px] leading-none">Wallet</span>
