# PowerShell script pour déployer Unlocky Landing Page
# Usage: .\deploy.ps1

Write-Host "🚀 Déploiement Unlocky Landing Page" -ForegroundColor Cyan
Write-Host ""
...
if (-Not (Test-Path .git)) {
    ...
    Write-Host "git remote add origin https://github.com/VOTRE-USERNAME/unlocky-landing-page.git"
...
Write-Host "  3. Sélectionnez 'unlocky-landing-page'"
